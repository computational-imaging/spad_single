...
\edit{Under these scene parameters, we can compute the total incident 
  ...
  low-flux regime where pileup is negligible~\cite{oconnortcspc}.
  We also empirically validate that our method works with a diffused setup and an output power of 
  approximately 25 mW without significant pileup effects as detailed in the supplement.
    ...
    using neutral density filters, or by using a pile-up correction technique~\cite{Heide:2018}.}
