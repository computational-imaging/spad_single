...
\begin{figure}[t!]
  \centering
  \includegraphics[width=0.6\columnwidth]{method.pdf}
  \caption{Overview of processing pipeline. The processing pipeline uses
      ...
      calculate a histogram matching matrix which is used to output the corrected depth. \edit{PLEASE CHANGE FIGURE LAYOUT!}
  }
  \label{fig:pipeline}
\end{figure}
