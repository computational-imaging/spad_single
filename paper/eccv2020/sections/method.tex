...
support of histogram bins containing signal photons (\ie the range of depths in the
...
\vspace{0.8em}\noindent{\bf Histogram Re-binning.}
...
We match the histogram $h_\text{source}$ to $h_\text{target}$ using the method of
